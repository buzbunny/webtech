  ...
  <body>
    <header class="section__container header__container">
      ...
      <div class="header__image">
        ...
        <a href="store.php" style="margin-left: 85%;"><span><span><i class="ri-admin-line"></i></span>Dashboard</span></a>  
        <a href="landing/login_page.php" style="margin-left: 85%;"><span><span><i class="ri-login-box-line"></i></span>Login</span></a>
        <?php
              // Check if user is logged in
              if(isset($_SESSION['email'])){
                  // If logged in, display link to settings page
                  echo '<a href="settings.php" style="margin-left: 85%;"><span><span><i class="ri-settings-3-line"></i></span>Settings</span></a>';
              } else {
                  // If not logged in, redirect to login page
                  echo '<a href="landing/login_page.php" style="margin-left: 85%;"><span><span><i class="ri-settings-3-line"></i></span>Settings</span></a>';
              }
            ?>
        <a href="logout.php" style="margin-left: 85%;"><span><span><i class="ri-logout-box-line"></i></span>Logout</span></a>
